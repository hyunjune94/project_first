			...
			<div class="row g-3">
			    ...
			    <div class="col-12 col-md-6">
						<label for="formGroupExampleInput" class="form-label">우편번호</label>
  						<input type="text" class="form-control" id="member_post" placeholder="Zip Code" onclick="findAddr()">
			    </div>
			    <div class="col-12 col-md-6">
			    	<label for="formGroupExampleInput" class="form-label">주소</label>
  					<input type="text" class="form-control" id="member_addr" placeholder="Address">
			    </div>
